# This week is all about conditionals
...
# Skipping the above section I want to see if I can do this without looking
# Testing for odds or evens

num = int(input("Pick any integer: "))
