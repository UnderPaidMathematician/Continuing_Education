...
'''
print("Compatibility testing algorithm.\n")
# Collect both of their names
first_name = input("What is the name of the first person in the relationship?\t").lower()
second_name = input("What is the name of the second person in this relationship?\t").lower()

# Combine both of their names and strip them. I just want the program to be more efficient. The blank values could have been left in there.

combined_names = first_name + second_name
combined_names = combined_names.strip()
...
# concatinate the strings and make them a number
# evaluate the numbers 
compatibility_score = int(str(tens_place)+str(ones_place))
...
elif (compatibility_score < 50) and (compatibility_score > 40):
